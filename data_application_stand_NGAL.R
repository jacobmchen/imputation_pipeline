...
mediation_data <- read.csv("mediation_data_final_NGAL_stand_T3.csv")
...
pipeline <- learnMediationDensities(pipeline, read_from_rds, "NGAL_STAND_T3_02252026")
...
pipeline <- learnTreatmentDensities(pipeline, read_from_rds, "NGAL_STAND_T3_02252026")

# learn the marginal treatment densities and update the object
pipeline <- learnMarginalTreatmentDensities(pipeline, read_from_rds, "NGAL_STAND_T3_02252026")
