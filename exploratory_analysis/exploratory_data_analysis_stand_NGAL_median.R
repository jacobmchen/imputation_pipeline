...
make_plot <- function(vec1, vec2, vec3, vec4, vec5, vec6, vec7, vec8, title, filename) {
  ...
  boxplot(list(T1_yes=T1_yes, T1_no=T1_no, T2_yes=T2_yes, T2_no=T2_no,
          ...
          main=title, ylab="Standardized NGAL")
...
print(compute_median_IQR(aki_yes_data$delta_NGAL_stand))

print("median and IQR KIM-1 change T2-T0")
print(compute_median_IQR(aki_yes_data$delta_NGAL_stand_T2))

print("median and IQR KIM-1 change T3-T0")
print(compute_median_IQR(aki_yes_data$delta_NGAL_stand_T3))

print("median and IQR KIM-1 change T4-T0")
print(compute_median_IQR(aki_yes_data$delta_NGAL_stand_T4))
...
# median and IQR for delta_KIM-1
print("median and IQR KIM-1 change T1-T0")
print(compute_median_IQR(aki_no_data$delta_NGAL_stand))

print("median and IQR KIM-1 change T2-T0")
print(compute_median_IQR(aki_no_data$delta_NGAL_stand_T2))

print("median and IQR KIM-1 change T3-T0")
print(compute_median_IQR(aki_no_data$delta_NGAL_stand_T3))

print("median and IQR KIM-1 change T4-T0")
print(compute_median_IQR(aki_no_data$delta_NGAL_stand_T4))

make_plot(aki_yes_data$delta_NGAL_stand, aki_yes_data$delta_NGAL_stand_T2,
          aki_yes_data$delta_NGAL_stand_T3, aki_yes_data$delta_NGAL_stand_T4,
          aki_no_data$delta_NGAL_stand, aki_no_data$delta_NGAL_stand_T2,
          aki_no_data$delta_NGAL_stand_T3, aki_no_data$delta_NGAL_stand_T4,
          "Q1, Median, and Q3 of Standardized NGAL\nCompared to Baseline for AKI Yes and No Populations",
          "plots/NGAL_stand_boxplot.png")
